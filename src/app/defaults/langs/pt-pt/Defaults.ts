export class Default_PT {
    static PRICE = "Preço"
    static NAME = "Nome"
    static DURATION = "Duração"
    static COLOR = "Cor"
    static CALENDARS = "Calendários"
    static ACTIVE = "Ativo"
    static TITLE = "Título"
    static SEX = "Sexo"
    static ADDRESS = "Morada"
    static BIRTHDATE = "Nascimento"
    static INSTAGRAM = "Instagram"
    static FACEBOOK = "Facebook"
    static OK_BTN = "Adicionar"
    static CANCEL_BTN = "Cancelar"
    static ACTIONS = "Ações"
    static PHONE_NUMBER = "Nº Telemóvel"
    static INIT_INTERVAL = "Início"
    static CLOSE_INTERVAL = "Fim"
    static WORKER = "Funcionário"
    static DATE = "Data"
    static REASON = "Motivo"
    static UNDEFINED = "<INDEFENIDO>"
    static MINUTES = "Minuto(s)"
    static EURO = "€"
    static CHANGE_BTN = "Guardar Alterações"
    static CREATE_WORKER_MODAL_TITLE = "A criar funcionário"
    static ASSOCS_CREATED = "Associações criadas com sucesso"
    static CREATE_PREDEFINED_EVENT_TITLE = "A criar evento predefinido"
    static EDIT_PREDEFINED_EVENT_TITLE = "A editar evento predefinido"
    ...
    static REPLACE_WORKER_PLACEHOLDER_TEXT = '--- Selecione um funcionário substituto ---'
    static MANAGING_WORKER = "A editar funcionário"
    static INVALID_INPUT = 'Os valores introduzidos são inválidos'
    static CREATE_EVENT_BTN_TEXT = 'Criar Evento'
    static EDIT_EVENT_BTN_TEXT = 'Editar Evento'
    static ADD_PRODUCT_PLACEHOLDER_TEXT = 'Anotações do produto...'
    static CREATE_FORM_TREATMENT = 'Criar tratamento/formulário'
    static PROMPT_CREATE_FORM_TREATMENT = 'Deseja criar um formulário/tratamento ou associar o evento a um tratamento existente?'
    static EVENT_ADDED = 'O evento foi adicionado com sucesso'
    static EVENT_EDITED = 'O evento foi editado com sucesso'
    static ERROR_COMPRESSING_FILE = 'Erro ao comprimir o ficheiro'
    static PREDEFINED_EVENT_ADDED = 'O evento predefinido foi adicionado com sucesso'
    static ADD_CAL_BTN_TEXT = "Adicionar Calendário"
    static INVALID_OPERATION_AT_LEAST_1_CAL = "É necessário pelo menos um calendário associado ao funcionário"
    static RMV_CAL_BTN_TEXT = 'Remover do Calendário'
    static EMPTY_PRODUCT_DESC_TEXT = '<Sem anotação>'
    static CREATE_CLIENT = 'A criar cliente'
    static ADD_PRODUCT_BTN_TEXT = 'Adicionar Produto'
    static REMOVE_PRODUCT_BTN_TEXT = 'Remover Produto'
    static INVALID_ARCHIVE = 'Arquivo Inválido'
    static COULD_NOT_GET_FORMS = 'Não foi possível obter os formulários'
    static CREATE_CLIENT_FAST_CREATION = "A criar cliente - Criação rápida"
    static SHOULD_NOT_BE_POSSIBLE = '?'
    static FILLING_FORM = "A preencher formulário"
    static MANAGE_FORMS_AND_TREATMENTS = 'Gestão de formulário e tratamento'
    static INVALID_FILE_TYPE = 'Tipo de ficheiro inválido'
    static CREATE_WORKER_TEXT = 'Criar funcionário'
    static PREDEFINED_EVENT_TEXT = 'Evento recorrente'
    static NOT_PREDEFINED_EVENT_TEXT = 'Evento não recorrente'
    static MAXIUM_IMAGE_AMOUNT_REACHED = 'Limite máximo de anexos atingido'
    static EDIT_CLIENT = 'A editar cliente'
    static EMPTY_COMMENT_TEXT = 'Nenhum comentário adicionado'
    static CLIENT_EDITED = 'O cliente foi editado com sucesso'
    static CLIENT_CREATED = 'O cliente foi criado com sucesso'
    static WORKER_CREATED = 'O funcionário foi criado com sucesso'
    static CREATE_EVENT = 'A Criar Evento'
    static EDIT_EVENT = 'A Editar Evento'
    static VISUALIZE_EVENT = 'A Visualizar Evento'
    static MANAGE_WORKERS = 'Gestão de funcionários'
    static CALENDAR_PENDING_CHANGES = 'Ações de Calendário Pendentes'
    static ACTIONS_NOT_SET_FOR_REMOVE_OR_DELETE = 'Algumas das ações pendentes não foram selecionadas'
    static OPEN_SIDE_MENU_TOOLTIP = 'Abrir menu lateral'
    static SHOW_FLOATING_MENU = 'Mostrar menu flutuante'
    static HIDE_FLOATING_MENU = 'Colapsar menu flutuante'
    ...
    static WORKER_PC_OVERLAY_TITLE = "A guardar alterações"
    static WORKER_PC_OVERLAY_DESC = "Espere um momento enquanto guarda-mos as alterações"
    ...
    static ABSENCES_PAGE_TITLE = 'Gestão de Ausências e Feriados'
    static INTERVAL_RANGE = "'Das' HH:mm:ss 'às' HH:mm:ss"
    ...
    static CALENDAR_2_ACTIVE = '♀ Feminino'
    static CALENDAR_3 = 'Laser'
    static CALENDAR_3_ACTIVE = '♨ Laser'
    static CALENDAR_4 = 'Estética'
    static CALENDAR_4_ACTIVE = '✧ Estética'
    static CLIENT_MENU_1 = 'Ativos'
    ...
    static DELETE_EVENT_TITLE = 'A Eliminar evento'
    static DELETE_PREDEFINED_EVENT_TITLE = 'A Eliminar evento predefinido'
    ...
    static DELETE_EVENT_MOBILE_PROMPT = 'Deseja eliminar o evento'
    static DELETE_CLIENT_SUCCESS = 'Cliente eliminado com sucesso'
    static DELETE_EVENT_SUCCESS = 'Evento eliminado com sucesso'
    static CREATE_FORM = "Criar"
    static DENY_CREATE_FORM = "Não"
    ...
    static AG_GRID_LOCALE_PT = {
        ...
        // Filtro de Número e Filtro de Texto
        filterOoo: 'Filtrar...',
        equals: 'Igual',
        notEqual: 'Diferente',
        blank: 'Vazio',
        ...
        // Painel de Ferramentas de Coluna
        ...
        groupBy: 'Agrupar por',
        ungroupBy: 'Remover Agrupamento por',
        ...
        removeFromLabels: 'Remover ${variable} das etiquetas',
        ...
        normalizedColumn: 'Empilhamento de 100%',

        barChart: 'Barra',
        groupedBar: 'Agrupado',
        stackedBar: 'Empilhado',
        normalizedBar: 'Empilhamento de 100%',
        ...
        normalizedArea: 'Empilhamento de 100%',
        ...
        itemSpacing: 'Espaçamento dos itens',
        itemPaddingX: 'Preenchimento X dos itens',
        itemPaddingY: 'Preenchimento Y dos itens',
        layoutHorizontalSpacing: 'Espaçamento Horizontal',
        layoutVerticalSpacing: 'Espaçamento Vertical',
        strokeWidth: 'Largura do traço',
        lineDash: 'Tipo de Traço',
        offset: 'Deslocamento',
        ...
        histogramBinCount: 'Quantidade de Bins',
        columnGroup: 'Coluna',
        barGroup: 'Barra',
        pieGroup: 'Pizza',
        lineGroup: 'Linha',
        scatterGroup: 'Dispersão XY',
        areaGroup: 'Área',
        ...
        normalizedAreaTooltip: 'Empilhada 100%',
        scatterTooltip: 'Dispersão XY',
        bubbleTooltip: 'Bolha',
        ...
        noDataToChart: 'Não há dados disponíveis para gerar gráfico.',
        pivotChartRequiresPivotMode: 'O Gráfico de Tabela Dinâmica requer o Modo de Tabela Dinâmica habilitado.',
