...
@Component({
  selector: 'app-mobile-create-worker-modal',
  templateUrl: './mobile-create-worker-modal.component.html',
  styleUrls: ['./mobile-create-worker-modal.component.scss'],
})
export class MobileCreateWorkerModalComponent {
  ...
  constructor(private formBuilder: FormBuilder, public api: APIService, public _snackBar: MatSnackBar, public modalController: ModalController) {
